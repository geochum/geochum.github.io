...
Here's an interesting solution to a problem where different projectiles, launched with varying initial speeds and angles, reach the same maximum height. We'll show that the time of flight is the same regardless of their initial velocities:
\[
